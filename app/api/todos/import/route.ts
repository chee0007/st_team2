...
import { todoDB, type Priority, type RecurrencePattern, type TodoExportItem } from '@/lib/db';
...
function toImportItems(payload: z.infer<typeof importSchema>): TodoExportItem[] {
...
export async function POST(request: NextRequest): Promise<NextResponse> {
  ...
  const result = todoDB.importAll(session.userId, toImportItems(parsed.data));
